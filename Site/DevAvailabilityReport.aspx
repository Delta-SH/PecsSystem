<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DevAvailabilityReport.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.DevAvailabilityReport" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        AmCharts.ready(function() {
            DevAvailability.renderAmSerialChart();
        });
        //]]>
    </script>
</head>
<body>
    ...
    <ext:Viewport ID="PageViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:Panel ID="ChartPanel" runat="server" AutoScroll="true" Region="Center" Title="监控可用率(可用率={1-监控模块(FSU)通讯中断时长/监控模块总时长}×100%)" Icon="ChartBar">
                <TopBar>
                                    ...
                                    <ext:DropDownField ID="RateCountField" runat="server" FieldLabel="统计选项" EmptyText="select an item..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="360" LabelWidth="50">
                                        <Component>
                                            <ext:TreePanel ID="RateCountTreePanel" runat="server" Header="false" Lines="true" Height="300" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="false">
                                                ...
                                                <Listeners>
                                                    <CheckChange Fn="DevAvailability.checkChanged" />
                                                </Listeners>
                                                <SelectionModel>
                                        ...
                                        <SyncValue Fn="DevAvailability.syncValue" />
                                    </ext:DropDownField>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="ChartTypeComboBox" runat="server" Width="180" LabelWidth="50" FieldLabel="图表类型" ForceSelection="true" SelectOnFocus="true" Resizable="true">
                                        ...
                                        <Listeners>
                                            <Select Fn="DevAvailability.selectType" Scope="DevAvailability" />
                                        </Listeners>
                                    </ext:ComboBox>
                                    ...
                                    <ext:SplitButton ID="QueryBtn" runat="server" Text="查询" Icon="Magnifier" StandOut="true">
                                                    ...
                                                    <ext:MenuItem ID="SaveMenuItem" runat="server" Text="打印/导出" Icon="Printer">
                                                        <DirectEvents>
                                                            <Click OnEvent="SaveBtn_Click" IsUpload="true">
                                                                <ExtraParams>
                                                                    <ext:Parameter Name="ColumnNames" Mode="Raw" Value="DevAvailability.getColumnNames(#{MainGridPanel})" />
                                                                </ExtraParams>
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:MenuItem>
                                        ...
                                        <DirectEvents>
                                            <Click OnEvent="QueryBtn_Click" Success="#{BottomPagingToolbar}.doLoad();DevAvailability.setData();">
                ...
                <Listeners>
                    <BeforeRender Fn="DevAvailability.setCenterPanel" Scope="DevAvailability" />
                </Listeners>
            </ext:Panel>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" Header="false"
                ...
                <Listeners>
                    <BeforeRender Fn="DevAvailability.setSouthPanel" Scope="DevAvailability" />
                </Listeners>
                <BottomBar>
