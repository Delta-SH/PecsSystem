<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MajorIncidentReport.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.MajorIncidentReport" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" Icon="ApplicationViewColumns" Title="重大故障统计" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="false" Region="Center">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                                    ...
                                    <ext:DropDownField ID="CountItemField" runat="server" FieldLabel="统计选项" EmptyText="select an item..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="180" LabelWidth="50" AllowBlank="false">
                                        <Component>
                                            <ext:TreePanel ID="CountItemTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="false" Height="300" Width="250">
                                                ...
                                                <Listeners>
                                                    <CheckChange Fn="MajorIncident.checkChanged" />
                                                </Listeners>
                                                <SelectionModel>
                                        ...
                                        <SyncValue Fn="MajorIncident.syncValue" />
                                    </ext:DropDownField>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:DropDownField ID="AlarmNameDropDownField" runat="server" FieldLabel="告警类型" Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="360" LabelWidth="50" EmptyText="select an item..." AllowBlank="false">
                                        <Component>
                                            <ext:TreePanel ID="AlarmNameTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="true" ContainerScroll="true" RootVisible="false" Height="300">
                                                <Root>
                                                    <ext:TreeNode />
                                                </Root>
                                                <Loader>
                                        ...
                                        <Listeners>
                                            <Expand Fn="MajorIncident.initAlarmNameTreePanel" Scope="MajorIncident" Single="true" />
                                        </Listeners>
                                    </ext:DropDownField>
                                    <ext:MultiCombo ID="AlarmLevelMultiCombo" runat="server" SelectionMode="All" Width="360" LabelWidth="50" FieldLabel="告警级别" EmptyText="select an item..." DisplayField="Name" ValueField="Id" ForceSelection="true" TriggerAction="All" Resizable="true" AllowBlank="false">
                                        <Store>
                ...
                <Listeners>
                    <CellDblClick Fn="MajorIncident.onGridCellDblClick" Scope="MajorIncident" />
                </Listeners>
