<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="energy006.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.energy006" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>机房PUE值统计</title>
    ...
    <script type="text/javascript" src="../Resources/js/public.source.js?v=3.3.0.0"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="currentLayout" runat="server" Border="false" Layout="VBoxLayout" Region="Center" Title="机房PUE值统计列表">
                    <LayoutConfig>
                        ...
                        <ext:Toolbar ID="Condition1" runat="server">
                            <Items>
                                ...
                                <ext:DropDownField ID="RangeField" runat="server" FieldLabel="统计范围" EmptyText="请选择统计范围..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="250" LabelWidth="50" Text="全部" UnderlyingValue="root">
                                    <Component>
                                        <ext:TreePanel ID="RangeTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="true" Height="300">
                                            ...
                                            <Listeners>
                                                <Click Fn="Energy006.itemClick" />
                                            </Listeners>
                                        </ext:TreePanel>
                                    </Component>
                                    <SyncValue Fn="Energy006.syncValue" />
                                </ext:DropDownField>
                                ...
                                <ext:Button ID="QueryButton" runat="server" Text="查询" Icon="Magnifier" StandOut="true">
                                    <DirectEvents>
                                        <Click OnEvent="QueryButtonClick" Success="#{MainPagingToolbar}.doLoad();Energy006.refreshChart();">
                    ...
                    <Items>
                        ...
                        <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="true" Flex="1">
                            <Store>
                                <ext:Store ID="MainStore" runat="server" AutoLoad="false" OnRefreshData="MainStoreRefresh">
                                    <Proxy>
                                        <ext:PageProxy />
                                    </Proxy>
                                    <Reader>
                                        <ext:JsonReader IDProperty="Key">
                                            <Fields>
                                                ...
                                                <ext:RecordField Name="Period" Type="String" />
                                                <ext:RecordField Name="Value" Type="String" />
                                                <ext:RecordField Name="TValue" Type="String" />
                                                <ext:RecordField Name="PUE" Type="String" />
                                            </Fields>
                                        </ext:JsonReader>
                                    </Reader>
                                    <BaseParams>
                             ...
                             <ColumnModel runat="server">
                                <Columns>
                                    <ext:Column Header="站点" DataIndex="Current" Align="Center" />
                                    <ext:Column Header="时段" DataIndex="Period" Align="Left" />
                                    <ext:Column Header="设备用电量" DataIndex="Value" Align="Left" />
                                    <ext:Column Header="总用电量" DataIndex="TValue" Align="Left" />
                                    <ext:Column Header="PUE值" DataIndex="PUE" Align="Left" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                            ...
                            <Listeners>
                                <CellDblClick Fn="Energy006.cellDblClick" Scope="Energy006" />
                            </Listeners>
