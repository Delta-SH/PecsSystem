<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="energy003.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.energy003" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="currentLayout" runat="server" Border="false" Layout="VBoxLayout" Region="Center" Title="电量同址同比列表">
                    <LayoutConfig>
                        ...
                        <ext:Toolbar ID="Condition1" runat="server">
                            <Items>
                                ...
                                <ext:DropDownField ID="RangeField" runat="server" FieldLabel="统计范围" EmptyText="请选择统计范围..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="250" LabelWidth="50" Text="全部" UnderlyingValue="root">
                                    <Component>
                                        <ext:TreePanel ID="RangeTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="true" Height="300">
                                            ...
                                            <Listeners>
                                                <Click Fn="Energy003.itemClick" />
                                            </Listeners>
                                        </ext:TreePanel>
                                    </Component>
                                    <SyncValue Fn="Energy003.syncValue" />
                                </ext:DropDownField>
                                ...
                                <ext:Button ID="QueryButton" runat="server" Text="查询" Icon="Magnifier" StandOut="true">
                                    <DirectEvents>
                                        <Click OnEvent="QueryButtonClick" Success="#{MainPagingToolbar}.doLoad();Energy003.refreshChart();">
                    ...
                    <Items>
                        ...
                        <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="true" Flex="1">
                            <Store>
                             ...
                             <ColumnModel runat="server">
                                <Columns>
                                    ...
                                    <ext:Column Header="去年同期" DataIndex="TValue" Align="Left" />
                                    <ext:Column Header="同比增量" DataIndex="CValue" Align="Left" />
                                    <ext:Column Header="同比增幅" DataIndex="Rate" Align="Left" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                            ...
                            <Listeners>
                                <CellDblClick Fn="Energy003.cellDblClick" Scope="Energy003" />
                            </Listeners>
