<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="energy005.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.energy005" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="currentLayout" runat="server" Border="false" Layout="VBoxLayout" Region="Center" Title="机房电量对比列表">
                    <LayoutConfig>
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Condition1" runat="server">
                            <Items>
                                ...
                                <ext:DropDownField ID="RangeField" runat="server" FieldLabel="对比站点" EmptyText="请勾选两个对比站点..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="250" LabelWidth="50">
                                    <Component>
                                        <ext:TreePanel ID="RangeTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="false" Height="300">
                                            <Root>
                                                <ext:TreeNode NodeID="root" Text="全部" Icon="World"/>
                                            </Root>
                                            <Listeners>
                                                <CheckChange Fn="Energy005.checkChanged"/>
                                            </Listeners>
                                        </ext:TreePanel>
                                    </Component>
                                    <SyncValue Fn="Energy005.syncValue" />
                                </ext:DropDownField>
                                ...
                                <ext:Button ID="QueryButton" runat="server" Text="查询" Icon="Magnifier" StandOut="true">
                                    <DirectEvents>
                                        <Click OnEvent="QueryButtonClick" Success="#{MainPagingToolbar}.doLoad();Energy005.refreshChart();">
                    ...
                    <Items>
                        ...
                        <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="true" Flex="1">
                            ...
                            <Listeners>
                                <CellDblClick Fn="Energy005.cellDblClick" Scope="Energy005" />
                            </Listeners>
