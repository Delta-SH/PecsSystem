<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailReport120.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.DetailReport120" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>单体电压低于1.85V的蓄电池节点列表</title>
            ...
            <ext:GridPanel ID="WndGridPanel" runat="server" Icon="ApplicationViewColumns" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="false" Region="Center">
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="First" Type="String" />
                                    <ext:RecordField Name="Last" Type="String" />
                                </Fields>
                            </ext:JsonReader>
                        </Reader>
                        <BaseParams>
                ...
                <ColumnModel ID="WndColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="节点名称" DataIndex="NodeName" Align="Left" />
                        <ext:Column Header="首次发生时间" DataIndex="First" Align="Left" />
                        <ext:Column Header="末次发生时间" DataIndex="Last" Align="Left" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
                ...
                <Listeners>
                    <RowContextMenu Fn="DetailWnd120.showGridRowContextMenu" Scope="DetailWnd120" />
                </Listeners>
                <BottomBar>
