<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceLogs.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.ServiceLogs" %>
    ...
    <ext:Viewport ID="LogViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="LogGridPanel" runat="server" AutoExpandColumn="Message" StripeRows="true"
                TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="服务日志"
                ...
                <ColumnModel ID="LogGridColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="事件信息" DataIndex="Message" Align="Left">
                            <Renderer Fn="ServiceLogs.setMessageTips" Scope="ServiceLogs" />
                        </ext:Column>
