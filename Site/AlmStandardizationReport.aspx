<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlmStandardizationReport.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.AlmStandardizationReport" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" Icon="ApplicationViewColumns" Title="告警标准化统计" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="false" Region="Center">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            <ext:Toolbar ID="TopToolbar1" runat="server" Flat="true">
                                <Items>
                                    ...
                                    <ext:DropDownField ID="CountItemField" runat="server" FieldLabel="统计选项" EmptyText="select an item..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="360" LabelWidth="50" AllowBlank="false">
                                        <Component>
                                            <ext:TreePanel ID="CountItemTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="false" Height="300">
                                                ...
                                                <Listeners>
                                                    <CheckChange Fn="AlmStandard.checkChanged" />
                                                </Listeners>
                                                <SelectionModel>
                                        ...
                                        <SyncValue Fn="AlmStandard.syncValue" />
                                    </ext:DropDownField>
                                    ...
                                    <ext:SplitButton ID="QueryBtn" runat="server" Text="查询" Icon="Magnifier" StandOut="true">
                                        ...
                                        <DirectEvents>
                                            <Click OnEvent="QueryBtn_Click" Success="#{MainGridPagingToolbar}.doLoad();" IsUpload="true">
                            ...
                            <ext:Toolbar ID="TopToolbar3" runat="server" Flat="true">
                                <Items>
                                    <ext:FileUploadField ID="StandardFileUploadField" runat="server" Width="540" EmptyText="请选择告警标准化Excel文件..." ButtonText="浏览..." Icon="Attach" AllowBlank="false">
                                        <Listeners>
                            ...
                            <ext:Toolbar ID="TopToolbar4" runat="server" Flat="true">
                                <Items>
                                    <ext:FileUploadField ID="ResourceFileUploadField" runat="server" Width="540" EmptyText="请选择综合资源Excel文件..." ButtonText="浏览..." Icon="Attach" AllowBlank="false">
                                        <Listeners>
                                            <FileSelected Handler="" />
                                        </Listeners>
                                    </ext:FileUploadField>
                ...
                <Listeners>
                    <CellDblClick Fn="AlmStandard.onGridCellDblClick" Scope="AlmStandard" />
                </Listeners>
