<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportantAlmReport.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.ImportantAlmReport" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" Icon="ApplicationViewColumns" Title="重要告警统计" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Border="false" Region="Center">
                <TopBar>
                                    ...
                                    <ext:DropDownField ID="CountItemField" runat="server" FieldLabel="统计选项" EmptyText="select an item..." Editable="false" TriggerIcon="Combo" Mode="ValueText" Width="360" LabelWidth="50" AllowBlank="false">
                                        <Component>
                                            <ext:TreePanel ID="CountItemTreePanel" runat="server" Header="false" Lines="true" AutoScroll="true" Animate="true" EnableDD="false" ContainerScroll="true" RootVisible="false" Height="300">
                                                ...
                                                <Listeners>
                                                    <CheckChange Fn="ImportantAlm.checkChanged" />
                                                </Listeners>
                                                <SelectionModel>
                                        ...
                                        <SyncValue Fn="ImportantAlm.syncValue" />
                                    </ext:DropDownField>
                                </Items>
                            </ext:Toolbar>
                ...
                <Listeners>
                    <CellDblClick Fn="ImportantAlm.onGridCellDblClick" Scope="ImportantAlm" />
                </Listeners>
