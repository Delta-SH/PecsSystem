<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report101.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report101" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>高低压配电系统负载率</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="高低压配电系统负载率 = ((机楼总负荷+机楼充电负荷)/变压器设计额定容量)×100%" Icon="ApplicationViewList">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="FilterTypeList" runat="server" FieldLabel="机楼负荷" LabelWidth="50" Width="180" Resizable="true">
                                        <Items>
                                    ...
                                    <ext:ComboBox ID="CFilterTypeList" runat="server" FieldLabel="充电负荷" LabelWidth="50" Width="180" Resizable="true">
                                        <Items>
                                            <ext:ListItem Text="按测点名称过滤" Value="0" />
                                            <ext:ListItem Text="按测点标记过滤" Value="1" />
                                        </Items>
                                    ...
                                    <ext:TextField ID="CNodeText" runat="server" Width="180" MaxLength="100" EmptyText="多条件请以；分隔" Text="" />
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="BuildingFH" Type="Float" />
                                    <ext:RecordField Name="BuildingCDFH" Type="Float" />
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="机楼总负荷(AH)" DataIndex="BuildingFH" Align="Left" />
                        <ext:Column Header="机楼充电负荷(AH)" DataIndex="BuildingCDFH" Align="Left" />
