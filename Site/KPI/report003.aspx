<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report003.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report003" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="温控系统可用度 = (1-高温告警时长/(温度测点总数×统计时长))×100%" Icon="ApplicationViewList">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            <ext:Toolbar ID="TopToolbar1" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="LscsComboBox" runat="server" Width="360" LabelWidth="50" FieldLabel="Lsc名称" Editable="true" DisplayField="Name" ValueField="Id" TypeAhead="true" Mode="Local" ForceSelection="true" TriggerAction="All" EmptyText="Loading..." SelectOnFocus="true" Resizable="true">
                                        <Store>
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="NodeCnt" Type="Int" />
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="高温告警时长(分钟)" DataIndex="Interval" Align="Left" />
                        <ext:Column Header="温度测点总数(个)" DataIndex="NodeCnt" Align="Left" />
