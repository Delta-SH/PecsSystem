<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report114.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report114" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>开关电源带载合格率</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="开关电源带载合格率=该月基站开关电源带载率合格套数/动环监控系统开关电源监控数量×100%" Icon="ApplicationViewList">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:TriggerField ID="BeginDate" runat="server" Width="250" LabelWidth="50" FieldLabel="查询时间">
                                        <Triggers>
                                    ...
                                    <ext:TriggerField ID="EndDate" runat="server" Width="250" LabelWidth="50" FieldLabel="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                        LabelSeparator="~">
                                        <Triggers>
                                            <ext:FieldTrigger Icon="Date" />
                                        </Triggers>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="该月基站开关电源带载率合格套数" DataIndex="ThisCount" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="动环监控系统开关电源监控数量" DataIndex="LastCount" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="开关电源带载合格率" DataIndex="Rate" Align="Left" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
                ...
                <Listeners>
                    <CellDblClick Fn="KPIReport114.GridCellDblClick" Scope="KPIReport114" />
                </Listeners>
                <BottomBar>
