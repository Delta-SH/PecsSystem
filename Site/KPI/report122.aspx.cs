...
namespace Delta.PECS.WebCSC.Site.KPI {
    [DirectMethodProxyID(IDMode = DirectMethodProxyIDMode.Alias, Alias = "report122")]
    public partial class report122 : PageBase {
        ...
        protected void SaveBtn_Click(object sender, DirectEventArgs e) {
            try {
                ...
                var fileName = "KPI-Report122.xls";
                var sheetName = "汇聚机房温度达标率";
                var title = "动力环境监控中心系统 汇聚机房温度达标率报表";
        ...
        public void ShowGridCellDetail(string title, string lscId, string date, string dataIndex) {
            var userData = UserData;
            if (HttpRuntime.Cache[WebUtility.GetCacheKeyName(userData, "kpi-report-122")] == null) {
                AddDataToCache();
            }
            ...
            if ("Count".Equals(dataIndex)) {
                ...
                win.AutoLoad.Params.Add(new Ext.Net.Parameter("Type", "kpi_report_122_1"));
                ...
                var win = WebUtility.GetNewWindow(800, 600, title, Icon.Printer);
                win.AutoLoad.Url = "~/StaWnd.aspx";
                win.AutoLoad.Params.Add(new Ext.Net.Parameter("Type", "kpi_report_122_2"));
                win.AutoLoad.Params.Add(new Ext.Net.Parameter("Title", title));
                win.AutoLoad.Params.Add(new Ext.Net.Parameter("LscID", lscId));
                win.AutoLoad.Params.Add(new Ext.Net.Parameter("Date", date));
                win.Render();
