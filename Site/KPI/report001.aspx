<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report001.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report001" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="直流系统可用度 = (1-开关电源蓄电池组总电压低告警时长/(开关电源蓄电池组数×统计时长))×100%" Icon="ApplicationViewList">
                <TopBar>
                        ...
                        <Items>
                            <ext:Toolbar ID="TopToolbar1" runat="server" Flat="true">
                                <Items>
                                    ...
                                    <ext:MultiCombo ID="DevTypeMultiCombo" runat="server" Width="180" SelectionMode="All" LabelWidth="50" FieldLabel="告警类型" EmptyText="select an item..." DisplayField="Name" ValueField="Id" ForceSelection="true" TriggerAction="All" Resizable="true">
                                        <Store>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="开关电源蓄电池组告警时长(分钟)" DataIndex="Interval" Align="Left" />
                        <ext:Column Header="开关电源蓄电池组数(组)" DataIndex="DevCnt" Align="Left" />
