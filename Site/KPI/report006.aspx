<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report006.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report006" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="监控覆盖率=该月实际监控站点总数/上月监控站点总数×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="该月实际监控站点总数" DataIndex="ThisCount" Align="Left" />
