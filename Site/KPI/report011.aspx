<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report011.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report011" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>其他站点监控可用度</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="监控可用度=（1-站点动环通信中断告警总时长（分钟）/资管系统站点总数×统计时长）×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="站点动环通信中断告警总时长(分钟)" DataIndex="Interval" Align="Left" />
                        <ext:Column Header="站点动环运行总时长(分钟)" DataIndex="TotalInterval" Align="Left" />
