<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report008.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report008" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="开关电源带载率=该月基站开关电源带载率合格套数/动环监控系统开关电源监控数量×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="开关电源带载率" DataIndex="Rate" Align="Left" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
