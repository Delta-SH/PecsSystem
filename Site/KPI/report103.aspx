<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report103.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report103" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>交流不间断系统负载率</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="交流不间断系统负载率 = (系统当前最大负荷/系统设计容量)×100%" Icon="ApplicationViewList">
                <TopBar>
                        ...
                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    ...
                                    <ext:ComboBox ID="FilterTypeList" runat="server" FieldLabel="负荷测点" LabelWidth="50" Width="180" Resizable="true">
                                        <Items>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="当前最大负荷(AH)" DataIndex="CurrentCapacity" Align="Left" />
