<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report002.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report002" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>交流不间断系统可用度</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="交流不间断系统可用度 = (1-(UPS蓄电池组总电压低告警时长+UPS旁路运行时长)/(UPS蓄电池组数×统计时长))×100%" Icon="ApplicationViewList">
                <TopBar>
                        ...
                        <Items>
                            <ext:Toolbar ID="TopToolbar1" runat="server" Flat="true">
                                <Items>
                                    ...
                                    <ext:MultiCombo ID="DevTypeMultiCombo" runat="server" Width="180" SelectionMode="All" LabelWidth="50" FieldLabel="告警类型" EmptyText="..." DisplayField="Name" ValueField="Id" ForceSelection="true" TriggerAction="All" Resizable="true">
                                        <Store>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="FilterList" runat="server" FieldLabel="告警测点" LabelWidth="50" Resizable="true" Width="180">
                                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar3" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="PFilterList" runat="server" FieldLabel="旁路测点" LabelWidth="50" Resizable="true" Width="180">
                                        <Items>
                                            <ext:ListItem Text="按测点名称过滤" Value="0" />
                                            <ext:ListItem Text="按测点标记过滤" Value="1" />
                                        </Items>
                                    ...
                                    <ext:TextField ID="PNodeText" runat="server" Width="180" MaxLength="100" EmptyText="多条件请以；分隔" Text="" />
                                    <ext:ComboBox ID="PAlmNameList" runat="server" FieldLabel="旁路告警" LabelWidth="50" Resizable="true" Width="180">
                                        <Items>
                                            <ext:ListItem Text="按告警名称过滤" Value="0" />
                                            <ext:ListItem Text="按告警编号过滤" Value="1" />
                                        </Items>
                                    ...
                                    <ext:TextField ID="PAlarmNameText" runat="server" Width="180" MaxLength="100" EmptyText="多条件请以；分隔" Text="" />
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="PInterval" Type="Float" />
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="UPS蓄电池组告警时长(分钟)" DataIndex="Interval" Align="Left" />
                        <ext:Column Header="UPS旁路运行时长(分钟)" DataIndex="PInterval" Align="Left" />
                        <ext:Column Header="UPS蓄电池组数(组)" DataIndex="DevCnt" Align="Left" />
