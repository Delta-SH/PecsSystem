<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report105.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report105" %>
            ...
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="交流不间断系统可用度 = (1-(UPS蓄电池组总电压低告警时长+UPS旁路运行时长)/(UPS蓄电池组数×统计时长))×100%" Icon="ApplicationViewList">
                    ...
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar3" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="PFilterTypeList" runat="server" FieldLabel="旁路测点" LabelWidth="50" Width="180" Resizable="true">
                                        <Items>
                                            <ext:ListItem Text="按测点名称过滤" Value="0" />
                                            <ext:ListItem Text="按测点标记过滤" Value="1" />
                                        </Items>
                            ...
                            <ext:Toolbar ID="TopToolbar4" runat="server" Flat="true">
                                <Items>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="UPS蓄电池组告警数量" DataIndex="AlarmCnt" Align="Left">
                            <CustomConfig>
                ...
                <Listeners>
                    <CellDblClick Fn="KPIReport105.GridCellDblClick" Scope="KPIReport105" />
                </Listeners>
                <BottomBar>
