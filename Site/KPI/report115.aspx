<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report115.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report115" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="温控容量合格率=（1-该月高温告警站点总数/上月配置了温度测点站点总数）×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="该月高温告警站点总数" DataIndex="ThisCount" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="上月配置了温度测点站点总数" DataIndex="LastCount" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="温控容量合格率" DataIndex="Rate" Align="Left" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
                ...
                <Listeners>
                    <CellDblClick Fn="KPIReport115.GridCellDblClick" Scope="KPIReport115" />
                </Listeners>
                <BottomBar>
