<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report113.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report113" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>关键监控测点接入率</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="关键监控测点接入率（开关电源、蓄电池总电压）=该月接入监控设备数量/上月站点电源设备总数×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="该月接入监控设备数量" DataIndex="ThisCount" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="上月站点电源设备总数" DataIndex="LastCount" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="关键监控测点接入率" DataIndex="Rate" Align="Left" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
                ...
                <Listeners>
                    <CellDblClick Fn="KPIReport113.GridCellDblClick" Scope="KPIReport113" />
                </Listeners>
                <BottomBar>
