<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report122.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.KPI.report122" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>汇聚机房温度达标率</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
            <Items>
                <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="汇聚机房温度达标率 = (1-汇聚机房高温数/汇聚机房总数)×100%" Icon="ApplicationViewList">
                    <TopBar>
                    ...
                    <ColumnModel ID="MainColumnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column Header="统计日期" DataIndex="Date" Align="Left" Width="150" />
                            <ext:Column Header="汇聚机房高温数" DataIndex="Count" Align="Left" Width="200">
                                <CustomConfig>
                                    <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                                </CustomConfig>
                            </ext:Column>
                            <ext:Column Header="汇聚机房总数" DataIndex="TotalCount" Align="Left" Width="200">
                                <CustomConfig>
                                    <ext:ConfigItem Name="DblClickEnabled" Mode="Value" Value="1" />
                                </CustomConfig>
                            </ext:Column>
                            <ext:Column Header="温度达标率" DataIndex="Rate" Align="Left" Width="200" />
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>
                    ...
                    <Listeners>
                        <CellDblClick Fn="KPIReport122.GridCellDblClick" Scope="KPIReport121" />
                    </Listeners>
                    <BottomBar>
