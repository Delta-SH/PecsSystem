...
namespace Delta.PECS.WebCSC.Site {
    [DirectMethodProxyID(IDMode = DirectMethodProxyIDMode.Alias, Alias = "report002")]
    public partial class report002 : PageBase {
        ...
        protected void SaveBtn_Click(object sender, DirectEventArgs e) {
            try {
                ...
                for (int i = 0; i < result.Count; i++) {
                    ...
                    DevCnt_Node.InnerText = devcnt.ToString();
                ...
                var fileName = "KPI-Report002.xls";
        ...
        private List<Report002Entity> AddDataToCache() {
            ...
            if (ptexts.Count == 0 && pauxSets.Count == 0) { return null; }
