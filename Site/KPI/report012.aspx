<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report012.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report012" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>传输机房直流系统可用度</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="传输机房直流系统可用度 = (1-开关电源蓄电池组总电压低告警时长/(开关电源蓄电池组数×统计时长))×100%" Icon="ApplicationViewList">
                <TopBar>
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="TotalInterval" Type="Float" />
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="开关电源一次下电告警总时长（分钟）" DataIndex="Interval" Align="Left" />
                        <ext:Column Header="开关电源累计运行总时长（分钟）" DataIndex="TotalInterval" Align="Left" />
