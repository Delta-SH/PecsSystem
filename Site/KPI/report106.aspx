<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report106.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report106" %>
            ...
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="温控系统可用度 = (1-高温告警时长/(温度测点总数×统计时长))×100%" Icon="ApplicationViewList">
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="温度测点总数" DataIndex="NodeCnt" Align="Left" />
                        <ext:Column Header="高温告警数量" DataIndex="AlarmCnt" Align="Left">
                            <CustomConfig>
                ...
                <Listeners>
                    <CellDblClick Fn="KPIReport106.GridCellDblClick" Scope="KPIReport106" />
                </Listeners>
                <BottomBar>
