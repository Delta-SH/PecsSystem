<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report007.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report007" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="动环关键监测点接入率（开关电源、蓄电池总电压）=该月实际接入监控设备数量/上月站点电源设备总数×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="该月实际接入监控设备数量" DataIndex="ThisCount" Align="Left" />
