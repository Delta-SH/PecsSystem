<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report104.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.report104" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>直流不间断系统可用度</title>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="直流不间断系统可用度 = (1-开关电源蓄电池组总电压低告警时长/(开关电源蓄电池组数×统计时长))×100%" Icon="ApplicationViewList">
                <TopBar>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="开关电源蓄电池组告警数量" DataIndex="AlarmCnt" Align="Left">
                            <CustomConfig>
                ...
                <Listeners>
                    <CellDblClick Fn="KPIReport104.GridCellDblClick" Scope="KPIReport104" />
                </Listeners>
                <BottomBar>
