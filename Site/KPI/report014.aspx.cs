...
namespace Delta.PECS.WebCSC.Site {
    [DirectMethodProxyID(IDMode = DirectMethodProxyIDMode.Alias, Alias = "report014")]
    public partial class report014 : PageBase {
        ...
        protected void OnMainStoreRefresh(object sender, StoreRefreshDataEventArgs e) {
            try {
                ...
                var result = HttpRuntime.Cache[cacheKey] as List<Report014Entity>;
        ...
        protected void SaveBtn_Click(object sender, DirectEventArgs e) {
            try {
                ...
                var fileName = "KPI-Report014.xls";
                var sheetName = "站点标识率";
