...
namespace Delta.PECS.WebCSC.Site {
    [DirectMethodProxyID(IDMode = DirectMethodProxyIDMode.Alias, Alias = "report007")]
    public partial class report007 : PageBase {
        ...
        protected void OnMainStoreRefresh(object sender, StoreRefreshDataEventArgs e) {
            try {
                ...
                var result = HttpRuntime.Cache[cacheKey] as List<Report007Entity>;
        ...
        protected void SaveBtn_Click(object sender, DirectEventArgs e) {
            try {
                ...
                var fileName = "KPI-Report007.xls";
