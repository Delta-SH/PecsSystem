<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlmMasking.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.AlmMasking" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" Border="false" TrackMouseOver="true" AutoScroll="true" Region="Center" Title="告警屏蔽列表" Icon="ApplicationViewList">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="MaskTypeList" runat="server" FieldLabel="屏蔽类型" LabelWidth="50" Width="180" Resizable="true">
                                        <Items>
                                            <ext:ListItem Text="全部" Value="0" />
                                            <ext:ListItem Text="屏蔽站点" Value="1" />
                                            <ext:ListItem Text="屏蔽设备" Value="2" />
                                            <ext:ListItem Text="屏蔽信号" Value="3" />
                                        </Items>
                                        <SelectedItem Value="0" />
                                    </ext:ComboBox>
                                    <ext:TriggerField ID="BeginDate" runat="server" Width="180" LabelWidth="50" FieldLabel="屏蔽时间">
                                        <Triggers>
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="MaskType" Type="String" />
                                    <ext:RecordField Name="MaskName" Type="String" />
                                    <ext:RecordField Name="MaskTime" Type="String" />
                                </Fields>
                            </ext:JsonReader>
                        </Reader>
                        <BaseParams>
                ...
                <ColumnModel ID="MianGridColumnModel" runat="server">
                    <Columns>
                        <ext:Column Header="序号" DataIndex="ID" Align="Left" Width="60" />
                        ...
                        <ext:Column Header="屏蔽类型" DataIndex="MaskType" Align="Left" />
                        <ext:Column Header="屏蔽名称" DataIndex="MaskName" Align="Left" Width="200" />
                        <ext:Column Header="屏蔽时间" DataIndex="MaskTime" Align="Left" Width="150" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
