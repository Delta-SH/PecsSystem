<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OilEngineReport.aspx.cs" Inherits="Delta.PECS.WebCSC.Site.OilEngineReport" %>
...
<body>
    ...
    <ext:Viewport ID="MainViewport" runat="server" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="MainGridPanel" runat="server" StripeRows="true" TrackMouseOver="true" AutoScroll="true" Region="Center" Height="500px" Title="油机发电统计" Icon="ApplicationViewList">
                <TopBar>
                    <ext:Toolbar ID="TopToolbars" runat="server" Layout="ContainerLayout">
                        <Items>
                            ...
                            <ext:Toolbar ID="TopToolbar2" runat="server" Flat="true">
                                <Items>
                                    <ext:ComboBox ID="SFilterList" runat="server" FieldLabel="停电测点" LabelWidth="50" Resizable="true" Width="180">
                                        <Items>
                                    ...
                                    <ext:TextField ID="SNodeText" runat="server" Width="180" MaxLength="100" EmptyText="多条件请以；分隔" Text="" />
                                    <ext:ComboBox ID="YFilterList" runat="server" FieldLabel="发电测点" LabelWidth="50" Resizable="true" Width="180">
                                        <Items>
                                            <ext:ListItem Text="按测点名称过滤" Value="0" />
                                            <ext:ListItem Text="按测点标记过滤" Value="1" />
                                        </Items>
                                    ...
                                    <ext:TextField ID="YNodeText" runat="server" Width="180" MaxLength="100" EmptyText="多条件请以；分隔" Text="" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar ID="TopToolbar3" runat="server" Flat="true">
                                <Items>
                                    ...
                                    <ext:TriggerField ID="BeginToDate" runat="server" Width="180" LabelWidth="50" FieldLabel="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" LabelSeparator="~">
                                        <Triggers>
                                            <ext:FieldTrigger Icon="Date" />
                                        </Triggers>
                                        <Listeners>
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ID">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="StaID" Type="Int" />
                                    <ext:RecordField Name="StaName" Type="String" />
                                    <ext:RecordField Name="PowerOff" Type="Int" />
                                    <ext:RecordField Name="OffInterval" Type="Float" />
                                    <ext:RecordField Name="PowerOn" Type="Int" />
                                    <ext:RecordField Name="OnInterval" Type="Float" />
                                </Fields>
                            </ext:JsonReader>
                        </Reader>
                        <BaseParams>
                ...
                <ColumnModel ID="MainColumnModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column Header="市电停电次数" DataIndex="PowerOff" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="dblClickEnabled" Value="1" Mode="Value" />
                                <ext:ConfigItem Name="wndType" Value="1" Mode="Value" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="市电停电时长(分钟)" DataIndex="OffInterval" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="dblClickEnabled" Value="1" Mode="Value" />
                                <ext:ConfigItem Name="wndType" Value="2" Mode="Value" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="油机发电次数" DataIndex="PowerOn" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="dblClickEnabled" Value="1" Mode="Value" />
                                <ext:ConfigItem Name="wndType" Value="3" Mode="Value" />
                            </CustomConfig>
                        </ext:Column>
                        <ext:Column Header="油机发电时长(分钟)" DataIndex="OnInterval" Align="Left">
                            <CustomConfig>
                                <ext:ConfigItem Name="dblClickEnabled" Value="1" Mode="Value" />
                                <ext:ConfigItem Name="wndType" Value="4" Mode="Value" />
                            </CustomConfig>
                        </ext:Column>
                    </Columns>
                </ColumnModel>
                ...
                <Listeners>
                    <CellDblClick Fn="OilEngineReport.GridCellDblClick" Scope="OilEngineReport" />
                </Listeners>
                <BottomBar>
